	...
	<body>
		...
		<div id="show-pensamento" class="content scaffold-show" role="main">
			...
			<ol class="property-list pensamento">
				...
				<g:if test="${pensamentoInstance?.nomeAutor}">
				<li class="fieldcontain">
					<span id="nomeAutor-label" class="property-label"><g:message code="pensamento.nomeAutor.label" default="Nome Autor" /></span>
					
						<g:each in="${pensamentoInstance.nomeAutor}" var="n">
